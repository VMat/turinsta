...
var ChatActionsMenuPage = (function () {
    ...
    ChatActionsMenuPage.prototype.editChat = function () {
        var _this = this;
        var inboxWritingModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_2__inbox_writing_inbox_writing__["a" /* InboxWritingPage */], { chat: __assign({}, this.chat), multipleSelection: true });
